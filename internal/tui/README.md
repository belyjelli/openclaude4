...
- **Toast strip:** a single line under the status block and above the transcript (inset ~2 columns like v3 notifications): errors/warnings use a tinted full-width background; info stays dim. Auto-clears after about five seconds (new toasts replace the previous one).
